/*
Note 1: Button can't handle the click event handleClickAgain('mario') function like normal JS does because the function would fire upon the page rendering.
